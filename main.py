...
PREFIX = 'xln!' #คำนำหน้าตอนใช้คำสั่ง
TOKEN = 'OTU1Mzg1ODA0Njk0MzU1OTg4.Yjg6Xg.7MZU_d3-WDdBnWD9Tr6TBIHKTOo' #token ของบอท
...
async def sms(ctx, phone=None, amount=None):
    if (str(ctx.message.channel.id) == '922797245642985542'):
